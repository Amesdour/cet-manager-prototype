# Déploiement CETManager Landfill Tracker — Railway (Gratuit)
...
- Sélectionnez `cet-manager-prototype`
...
|----------|------------------------------|--------------|
| Admin    | admin@demo-cet.dz        | admin123     |
| Opérateur| operateur1@demo-cet.dz   | op1234       |
