...
**CETManager — Loi 18-07, Art. 12 — Déclaration ANPDP**
...
| **Responsable** | CETManager, Directeur |
...
| **Catégories concernées** | Agents CETManager |
...
| **Note** | Les clients sont principalement des personnes morales (entreprises, communes). Les données des personnes physiques (Client Comptant Démo, Client Prépayé Démo) constituent des données personnelles au sens de la Loi 18-07. |
